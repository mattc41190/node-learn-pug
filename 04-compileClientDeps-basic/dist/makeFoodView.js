...
function template(locals) {
  ...
  try {;
    ...
    (function(food) {;
      pug_debug_line = 1;
      pug_debug_filename = "food-view";
      pug_html = pug_html + "\u003Ch2\u003E";;
      pug_debug_line = 1;
      pug_debug_filename = "food-view";
      pug_html = pug_html + (pug_escape(
        null == (pug_interp = food)
        ? ""
        : pug_interp)) + "\u003C\u002Fh2\u003E";;
      pug_debug_line = 1;
      pug_debug_filename = "src\u002Fhelper.pug";
      pug_html = pug_html + "\u003Csmall\u003E";;
      pug_debug_line = 1;
      pug_debug_filename = "src\u002Fhelper.pug";
      pug_html = pug_html + "This is subject to change\u003C\u002Fsmall\u003E";
    }.call(
      this, "food" in locals_for_with
      ? locals_for_with.food
